...
export default function MechanicPanneDetailScreen() {
  ...
  useEffect(() => {
    ...
    supabase.from('mechanics').select('*').eq('user_id', user.id).maybeSingle()
      .then(({ data }) => { if (data) setMechanic(data as Mechanic); });
  }, [user]);
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <View style={[styles.topBar, { paddingTop: insets.top + Spacing.md }]}>
        ...
        <Text style={styles.topTitle}>Detail de la panne</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {isOpen && alreadyOffered && !success && (
          <View style={styles.successBanner}>
            ...
            <Text style={styles.successText}>Votre offre a ete soumise. En attente de reponse du client.</Text>
          </View>
        )}
        ...
        {success && (
          <View style={styles.successBanner}>
            <Star size={18} color={Colors.warning} fill={Colors.warning} />
            <Text style={styles.successText}>Offre envoyee avec succes ! En attente de reponse.</Text>
          </View>
        )}
        ...
        {isOpen && !alreadyOffered && (
          <View style={styles.offerCard}>
            ...
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>Delai d'arrivee (minutes)</Text>
              <TextInput
                style={styles.input}
                value={eta}
                onChangeText={setEta}
            ...
            <View style={styles.fieldGroup}>
              ...
              <TextInput
                ...
                placeholder="Ex: Je suis equipe pour ce type de panne..."
                placeholderTextColor={Colors.textTertiary}
                multiline
                numberOfLines={3}
              />
