...
const STATUT_NEXT: Partial<Record<InterventionStatut, { label: string; next: InterventionStatut }>> = {
  ...
  en_route:  { label: 'Marquer arrivée',        next: 'arrivee' },
  arrivee:   { label: 'Démarrer intervention',  next: 'en_cours' },
      ...
      >
        ...
        {!loading && interventions.length === 0 && (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyDesc}>Vos interventions acceptées apparaîtront ici.</Text>
          </View>
        )}
      </ScrollView>
    </View>
